...
def marksheet():
       ...
       Label_Father_Name = Label(Frame_1, text = 'Initial', font = ('arial',15,'bold'), bg = 'Navajo white')
       ...
       Label_Mother_Name = Label(Frame_1, text = 'Year', font = ('arial',15,'bold'), bg = 'Navajo white')
       ...
       Label_School = Label(Frame_1, text = 'Programme Name', font = ('arial',15,'bold'), bg = 'Navajo white')
       ...
       Label_1 = Label(Frame_2, text = 'C PROGRAMMING', font = ('arial',14), bg = 'Navajo white')
       Label_1.grid(row = 4, column = 0)
       Label_2 = Label(Frame_2, text = 'ALLIED MATHEMATICS-1', font = ('arial',14), bg = 'Navajo white')
       Label_2.grid(row = 5, column = 0)
       Label_3 = Label(Frame_2, text = 'TAMIL-1', font = ('arial',14), bg = 'Navajo white')
       Label_3.grid(row = 6, column = 0)
       Label_4 = Label(Frame_2, text = 'C PROGRAMMING LAB', font = ('arial',14), bg = 'Navajo white')
       Label_4.grid(row = 7, column = 0)
       Label_5 = Label(Frame_2, text = 'ENGLISH-1', font = ('arial',14), bg = 'Navajo white')
